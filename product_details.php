  ...
  <div class="row">
    <div class="col-md-10">
      ...
      <div class="col-md-4">
        <!-- card -->
        <div class='card'>
                <img src='./img/dress.jpg' class='card-img-top' alt='$product_title'>
                <div class='card-body'>
      ...
      <div class="col-md-8">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src='./img/blue_dress.jpg' class='card-img-top' alt='$product_title'>
            </div>
            <div class="col-md-6">
                <img src='./img/white_dress.jpg' class='card-img-top' alt='$product_title'>
            </div>
        </div>
      </div>
  <!-- fetching products -->
